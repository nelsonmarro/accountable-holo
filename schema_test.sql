...
ALTER TABLE transactions
ADD CONSTRAINT uq_transaction_number UNIQUE (transaction_number);ALTER TABLE transactions ADD COLUMN attachment_path TEXT;INSERT INTO categories (name, type, created_at, updated_at) VALUES ('Ajuste por Reconciliación', 'Ajuste', NOW(), NOW());
